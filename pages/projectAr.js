...
const teamMembers = [
  {
    name: "صوره توضح الصب بمضخه خرسانة خاصة في الحطة الاولى لجدران حلة الخزان العلوي 500م3",
    major:
      "الموقع: وادي الدواسر .",
    image:
      "/خز.jpg",
...
"/school2.jpg",
  },
  {
    ...
    major:
      "الموقع: منطقة الدوادمي .",
    image:
      "ارضي.jpg",
  }, {
    name: "صوره توضح وضع سلم داخل خزان ",
    major:
    "الموقع: منطقة الدوادمي .",
    image:
      "سلم.jpg",
  ...
  {
    name: "صوره توضح تركيب خطوط الطرد من المضخات",
  ...
  {
    name:"صوره توضح اعمال لعز ب الايبوكسي لحله خزان ام سمره ",
    major:
      "الموقع: وادي الدواسر .",
    image:
    "/دوامي3.jpg",
  ...
  {
    name: "صوره توضح انهاء تركيب السلك الشائك في موقع الشرفا ",
    major:
    "الموقع: وادي الدواسر .",
    image:
    "/شيك.jpg",
  ...
  {
    name: "صوره توضح تركيب لوحات الكهرباء في مبنى الضخ في حي الشرافا",
    major:
    "الموقع: وادي الدواسر .",
    image:
   "/لوحه.jpg" ,
  ...
  {
    name: "صوره توضح تركيب المضخات في مبنى الضخ",
    major:      "الموقع: وادي الدواسر .",
