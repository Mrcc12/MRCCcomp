...
const teamMembers = [
  ...
  },
  {
    ...
    major: "الموقع: أمانة العيينة وبلدية الجبيلة.",
    image: "/water.jpg",
  },
  {
  ...
  },
  {
    ...
    major: "الموقع: محافظة وادي الدواسر",
    image: "/دواسي.jpg",
  },
  {
    name: "عقد استكمال التوصيلات المنزلية والعدادات بمدن وقرى  منطقة جازان",
    major: "الموقع: منطقة جازان",
    image: "/jazan.jpg",
  },
];
              ...
              {teamMembers.map((member, index) => (
                ...
                >
                  ...
                  <div
                    ...
                    style={{ direction: "rtl" }}
                  >
                    <h1 className="text-black text-xl font-dmserif">
                      {member.name}
                    </h1>
